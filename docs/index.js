(function(global, factory) {
...
})(this, function(echartsLib, tooltip, legend, bar, echarts) {
  "use strict";

  echartsLib =
    echartsLib && echartsLib.hasOwnProperty("default")
      ? echartsLib["default"]
      : echartsLib;
  echarts =
  ...
  const itemPoint = function itemPoint(color) {
    return [
      '<span style="',
  ...
  function toFixed(value, maxDecimals, roundingFunction, optionals) {
    ...
    if (optionals > maxDecimals - boundedPrecision) {
      var optionalsRegExp = new RegExp(
  ...
  var _typeof$1 =
    typeof Symbol === "function" && _typeof(Symbol.iterator) === "symbol"
      ? function(obj) {
    ...
    return {
      ...
      formatter: function formatter(items) {
        ...
        items.forEach(function(item) {
          ...
          var type = ~secondAxis.indexOf(seriesName)
            ? meaAxisType[1]
            : meaAxisType[0];
  ...
  function getBarSeries(args) {
    ...
    series = Object.keys(seriesTemp).map(function(item, index) {
      ...
      var itemOpacity =
        opacity || get$1(seriesItem, "itemStyle.normal.opacity");
  ...
  var bar$1 = function bar$$1(columns, rows, settings, extra) {
    ...
    var _settings$axisSite = settings.axisSite,
      ...
      dimension =
        _settings$dimension === undefined ? [columns[0]] : _settings$dimension,
      _settings$stack = settings.stack,
      stack = _settings$stack === undefined ? {} : _settings$stack,
      _settings$axisVisible = settings.axisVisible,
      axisVisible =
        _settings$axisVisible === undefined ? true : _settings$axisVisible,
      _settings$digit = settings.digit,
      digit = _settings$digit === undefined ? 2 : _settings$digit,
      _settings$dataOrder = settings.dataOrder,
      dataOrder =
        _settings$dataOrder === undefined ? false : _settings$dataOrder,
      ...
      legendName =
        _settings$legendName === undefined ? {} : _settings$legendName,
  ...
  var __vue_inject_styles__$1 = function __vue_inject_styles__(inject) {
    if (!inject) return;
    inject("data-v-a8d93b58_0", {
      source:
        "\n.v-charts-data-empty {\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: rgba(255, 255, 255, .9);\n  color: #888;\n  font-size: 14px;\n}\n",
      map: {
        version: 3,
        sources: [
          "/Users/gaowujun/tanzhou/tz-chart/src/components/data-empty.vue"
        ],
        names: [],
        mappings:
          ";AAOA;EACA,kBAAA;EACA,OAAA;EACA,QAAA;EACA,MAAA;EACA,SAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,yCAAA;EACA,WAAA;EACA,eAAA;AACA",
        file: "data-empty.vue",
        sourcesContent: [
    ...
    methods: {
      ...
      optionsHandler: function optionsHandler(options) {
        ...
        ECHARTS_SETTINGS.forEach(function(setting) {
          if (_this[setting]) {
            options[setting] = _this.mergeData(
              options[setting],
              _this[setting]
            );
          }
    ...
    return {
      ...
      formatter: function formatter(items) {
        ...
        items.forEach(function(_ref) {
          ...
          var showData = null;
          var type = ~rightList.indexOf(seriesName)
            ? yAxisType[1]
            : yAxisType[0];
          var itemData = isArray(data) ? data[1] : data;
          showData = getFormated(itemData, type, digit);
          var marker =
            '<span style="display:inline-block;margin-right:5px;border-radius:6px;width:6px;height:6px;background-color:' +
            color +
            ';"></span>';
          tpl.push(marker);
  ...
  var line$1 = function line$$1(columns, rows, settings, extra) {
    ...
    var _settings$axisSite = settings.axisSite,
      ...
      yAxisType =
        _settings$yAxisType === undefined
          ? ["normal", "normal"]
          : _settings$yAxisType,
      _settings$xAxisType = settings.xAxisType,
      xAxisType =
        _settings$xAxisType === undefined ? "category" : _settings$xAxisType,
      ...
      nullAddZero =
        _settings$nullAddZero === undefined ? false : _settings$nullAddZero,
      _settings$digit = settings.digit,
      digit = _settings$digit === undefined ? 2 : _settings$digit,
      _settings$legendName = settings.legendName,
      legendName =
